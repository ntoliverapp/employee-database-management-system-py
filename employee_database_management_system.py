...
class Employee:
    def __init__(self,root): 
        ...
        #create frames
        main_frame = Frame(self.root, bd=2, width=1340, height=650, bg='#113B8E', relief = RIDGE)
        main_frame.grid()
        
        top_frame_1 = Frame(self.root, bd=2, width=1340, height=50, bg='#113B8E', relief=RIDGE)
        top_frame_1.grid(row=2, column=0)
        
        top_frame_2 = Frame(self.root, bd=2, width=1340, height=100, bg='#113B8E', relief=RIDGE)
        top_frame_2.grid(row=1, column=0)
        
        top_frame_3 = Frame(self.root, bd=2, width=1340, height=400, bg='#113B8E', relief=RIDGE)
        top_frame_3.grid(row=0, column=0)

        left_frame = Frame(top_frame_3, bd=5, width=1340, height=400, padx=2, bg='#AAABE6', relief=RIDGE)
        ...
        #=========================================Reference============================================================
        self.lb_reference= Label(left_frame_1, font=('arial', 12, 'bold'), bg='#AAABE6',text = 'Reference', bd=1, anchor='w')
        self.lb_reference.grid(row=0,column=0)
        self.txt_reference= Entry(left_frame_1, font=('arial', 12, 'bold'), highlightcolor='#AAABE6', highlightbackground='#AAABE6', bg='#c7f7fa',bd=1, width=60, justify= 'left', textvariable = reference)
        self.txt_reference.grid(row=0,column=1)
        
        #------------------------------------------First Name-----------------------------------------------------------
        self.lb_first_name= Label(left_frame_1, font=('arial', 12, 'bold'), bg='#AAABE6',text = 'First Name', bd=1, anchor='w')
        self.lb_first_name.grid(row=1,column=0)
        self.txt_first_name= Entry(left_frame_1, font=('arial', 12, 'bold'), highlightcolor='#AAABE6', highlightbackground='#AAABE6', bg='#c7f7fa',bd=1, width=60, justify= 'left', textvariable = first_name)
        self.txt_first_name.grid(row=1,column=1)
        
        #------------------------------------------Last Name-----------------------------------------------------------
        self.lb_last_name= Label(left_frame_1, font=('arial', 12, 'bold'), bg='#AAABE6',text = 'Last Name', bd=1, anchor='w')
        self.lb_last_name.grid(row=2,column=0)
        self.txt_last_name= Entry(left_frame_1, font=('arial', 12, 'bold'), highlightcolor='#AAABE6', highlightbackground='#AAABE6', bg='#c7f7fa',bd=1, width=60, justify= 'left', textvariable = last_name)
        self.txt_last_name.grid(row=2,column=1)
        
        #------------------------------------------Address-----------------------------------------------------------
        self.lb_address= Label(left_frame_1, font=('arial', 12, 'bold'), bg='#AAABE6',text = 'Address', bd=1, anchor='w')
        self.lb_address.grid(row=3,column=0)
        self.txt_address= Entry(left_frame_1, font=('arial', 12, 'bold'), highlightcolor='#AAABE6', highlightbackground='#AAABE6', bg='#c7f7fa',bd=1, width=60, justify= 'left', textvariable = address)
        self.txt_address.grid(row=3,column=1)
        
        #------------------------------------------Gender-----------------------------------------------------------
        self.lb_gender= Label(left_frame_1, font=('arial', 12, 'bold'), bg='#AAABE6',text = 'Gender', bd=1, anchor='w')
        self.lb_gender.grid(row=4,column=0)
        self.txt_gender= Entry(left_frame_1, font=('arial', 12, 'bold'), highlightcolor='#AAABE6', highlightbackground='#AAABE6', bg='#c7f7fa',bd=1, width=60, justify= 'left', textvariable = gender)
        self.txt_gender.grid(row=4,column=1)
        
        #------------------------------------------Phone-----------------------------------------------------------
        self.lb_phone= Label(left_frame_1, font=('arial', 12, 'bold'), bg='#AAABE6',text = 'Phone', bd=1, anchor='w')
        self.lb_phone.grid(row=5,column=0)
        self.txt_phone= Entry(left_frame_1, font=('arial', 12, 'bold'), highlightcolor='#AAABE6', highlightbackground='#AAABE6', bg='#c7f7fa',bd=1, width=60, justify= 'left', textvariable = phone)
        self.txt_phone.grid(row=5,column=1)
        
        #------------------------------------------City Weighting-----------------------------------------------------------
        self.lb_city_weighting= Label(left_frame_2_left, font=('arial', 12, 'bold'), bg='#AAABE6',text = 'City Weighting', bd=1, anchor='e')
        self.lb_city_weighting.grid(row=0,column=0)
        self.txt_city_weighting= Entry(left_frame_2_left, font=('arial', 12, 'bold'), highlightcolor='#AAABE6', highlightbackground='#AAABE6', bg='#c7f7fa',bd=1, width=20, justify= 'left', textvariable = city_weighting)
        self.txt_city_weighting.grid(row=0,column=1)
        
        #------------------------------------------Basic Salary-----------------------------------------------------------
        self.lb_basic_salary= Label(left_frame_2_left, font=('arial', 12, 'bold'), bg='#AAABE6',text = 'Salary', bd=1, anchor='e')
        self.lb_basic_salary.grid(row=1,column=0)
        self.txt_basic_salary= Entry(left_frame_2_left, font=('arial', 12, 'bold'), highlightcolor='#AAABE6', highlightbackground='#AAABE6', bg='#c7f7fa',bd=1, width=20, justify= 'left', textvariable = basic_salary)
        self.txt_basic_salary.grid(row=1,column=1)
        
        #------------------------------------------Over Time-----------------------------------------------------------
        self.lb_over_time= Label(left_frame_2_left, font=('arial', 12, 'bold'), bg='#AAABE6',text = 'Over Time', bd=1, anchor='e')
        self.lb_over_time.grid(row=2,column=0)
        self.txt_over_time= Entry(left_frame_2_left, font=('arial', 12, 'bold'), highlightcolor='#AAABE6', highlightbackground='#AAABE6', bg='#c7f7fa',bd=1, width=20, justify= 'left', textvariable = over_time)
        self.txt_over_time.grid(row=2,column=1)
        
        #------------------------------------------Other Payment Due-----------------------------------------------------------
        self.lb_other_payment_due= Label(left_frame_2_left, font=('arial', 12, 'bold'), bg='#AAABE6',text = 'Other Payment', bd=1, anchor='e')
        self.lb_other_payment_due.grid(row=3,column=0)
        self.txt_other_payment_due= Entry(left_frame_2_left, font=('arial', 12, 'bold'), highlightcolor='#AAABE6', highlightbackground='#AAABE6', bg='#c7f7fa',bd=1, width=20, justify= 'left', textvariable = other_payment_due)
        self.txt_other_payment_due.grid(row=3,column=1)
        
        #------------------------------------------Tax-----------------------------------------------------------
        self.lb_tax= Label(left_frame_2_right, font=('arial', 12, 'bold'), bg='#AAABE6',text = 'Tax', bd=1, anchor='e')
        self.lb_tax.grid(row=0,column=0)
        self.txt_tax= Entry(left_frame_2_right, font=('arial', 12, 'bold'), highlightcolor='#AAABE6', highlightbackground='#AAABE6', bg='#c7f7fa',bd=1, width=20, justify= 'left', textvariable = tax)
        self.txt_tax.grid(row=0,column=1)
        
        #------------------------------------------Pension-----------------------------------------------------------
        self.lb_pension= Label(left_frame_2_right, font=('arial', 12, 'bold'), bg='#AAABE6',text = 'Pension', bd=1, anchor='e')
        self.lb_pension.grid(row=1,column=0)
        self.txt_pension= Entry(left_frame_2_right, font=('arial', 12, 'bold'), highlightcolor='#AAABE6', highlightbackground='#AAABE6', bg='#c7f7fa',bd=1, width=20, justify= 'left', textvariable = pension)
        self.txt_pension.grid(row=1,column=1)
        
        #------------------------------------------Student Loan-----------------------------------------------------------
        self.lb_std_loan= Label(left_frame_2_right, font=('arial', 12, 'bold'), bg='#AAABE6',text = 'Student Loan', bd=1, anchor='e')
        self.lb_std_loan.grid(row=2,column=0)
        self.txt_std_loan= Entry(left_frame_2_right, font=('arial', 12, 'bold'), highlightcolor='#AAABE6', highlightbackground='#AAABE6', bg='#c7f7fa',bd=1, width=20, justify= 'left', textvariable = std_loan)
        self.txt_std_loan.grid(row=2,column=1)
        
        #------------------------------------------NI Payment-----------------------------------------------------------
        self.lb_ni_payment= Label(left_frame_2_right, font=('arial', 12, 'bold'), bg='#AAABE6',text = 'NI Payment', bd=1, anchor='e')
        self.lb_ni_payment.grid(row=3,column=0)
        self.txt_ni_payment= Entry(left_frame_2_right, font=('arial', 12, 'bold'), highlightcolor='#AAABE6', highlightbackground='#AAABE6', bg='#c7f7fa',bd=1, width=20, justify= 'left', textvariable = ni_payment)
